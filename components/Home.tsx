      ...
      <div className="relative">
          ...
          <div className="flex flex-col justify-center items-center pt-10 gap-y-4 relative" >
            ...
            <div className="flex flex-col border rounded-sm w-[90vw] h-fit p-4 ">
              ...
              <div className="w-full flex justify-between p-3 items-center">
                ...
                <div className="justify-center items-center">
                  <label className="text-white text-md">Passionate about UI/UX. Over 2 years of development experience in HTML, CSS, JS, React,NextJS And TailwindCSS  frameworks.</label>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col border rounded-sm w-[90vw] h-fit p-4 ">
              <div className="w-full flex justify-between text-left p-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="38" height="46.769" viewBox="0 0 38 46.769"><path d="M39.275,46.769h-13.7a.972.972,0,0,1-.69-.286L12.86,34.4a.976.976,0,0,1,0-1.376L24.886,20.964a.981.981,0,0,1,.692-.288h13.7a.974.974,0,0,1,.692,1.66L28.645,33.712,39.967,45.1a.977.977,0,0,1-.692,1.664Zm-13.3-1.949H36.932L26.579,34.4a.974.974,0,0,1,0-1.374l10.351-10.4H25.981L14.926,33.712ZM10.1,31.269a.972.972,0,0,1-.69-.286l-6.875-6.91a.976.976,0,0,1,0-1.376L24.86.286a.977.977,0,0,1,.894-.265H39.246a.974.974,0,0,1,.692,1.66l-29.147,29.3A.976.976,0,0,1,10.1,31.269ZM4.6,23.384l5.5,5.528L36.9,1.97H25.932Z" transform="translate(-2.25 0)" fill="#fff"></path></svg>
                <div className="flex  w-4/6 flex-col">
                  <div className="relative w-fit ">
                    <h2 className="text-white text-2xl relative z-50
                      ">Flutter Dev </h2>
              ...
              <div className="w-full flex justify-between p-3 items-center">
                ...
                <div className="justify-center items-center">
                  <label className="text-white text-md">Skilled in developing hybrid mobile apps and cross-platform solutions using the Flutter framework.</label>
                </div>
              </div>
            </div>
        ...
        <div className="relative pt-6 bg-bg ">
          <div className="p-6 text-white">
            <label className="text-6xl font-bold">My<br></br> Work</label>
            <p className="pl-2 font-bold pt-4">Deployed scalable Tailoring, event and fininfolib web and hybrid mobile apps using Flutter And  React SPA.<br></br>
            Collaborated in 30+ projects with 15+ clients all around the world. I am also interested in Open Source Contribution.</p>
          </div>
